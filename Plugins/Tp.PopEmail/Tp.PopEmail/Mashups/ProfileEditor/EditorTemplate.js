...
'<tr><td nowrap><span class="rules-actions">create request in project PROJECT ID</span></td><td> request will be created from email for a given project</td></tr>' +
'</table>' +
'<br><br>' +
...
'<div class="rules-block">when <span class="rules-conditions">subject contains \'Targetprocess, tp\'</span> and <span class="rules-conditions">company matched to project 2</span> then <span class="rules-actions">attach to project 2</span> and <span class="rules-actions">create request in project 2</span>' +
...
'<br>then <span class="rules-actions">attach to project 1</span> and <span class="rules-actions">create request in project 1</span></div>' +
'<br>'+
...
'&nbsp;will match and the message will attach to Project 2, with request created in this project.</li>'+
...
'<li>All the other messages not matching to  any of the first 2 rules will be moved to Project 1, with requests created for Project 1.</li>'+
'</ol><br><br></div>' +
