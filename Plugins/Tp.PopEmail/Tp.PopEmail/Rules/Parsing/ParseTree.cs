...
namespace Tp.PopEmailIntegration.Rules.Parsing
{
    ...
    public partial class ParseNode
    {
        ...
        internal object Eval(ParseTree tree, params object[] paramlist)
        {
            ...
            switch (Token.Type)
            {
                case TokenType.SubjectContainsClause:
                    Value = EvalSubjectContainsClause(tree, paramlist);
                    break;
                case TokenType.AttachToProjectClause:
                    Value = EvalAttachToProjectClause(tree, paramlist);
                    break;
                ...
                case TokenType.CompanyMatchedClause:
                    ...
                    break;
                case TokenType.AttachRequestToTeamClause:
                    Value = EvalAttachRequestToTeamClause(tree, paramlist);
                    break;
                case TokenType.AttachRequestToTeamPart:
                    Value = EvalAttachRequestToTeamPart(tree, paramlist);
                    break;
                case TokenType.WhenStatement:
                    Value = EvalWhenStatement(tree, paramlist);
                    break;
                case TokenType.WhenPart:
                    Value = EvalWhenPart(tree, paramlist);
                    break;
                case TokenType.ThenStatement:
                    Value = EvalThenStatement(tree, paramlist);
                    break;
                case TokenType.ThenPart:
                    Value = EvalThenPart(tree, paramlist);
                    break;
        ...
        protected virtual object EvalAttachRequestToTeamClause(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }

        protected virtual object EvalAttachRequestToTeamPart(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }

        protected virtual object EvalWhenStatement(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }

        protected virtual object EvalWhenPart(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }

        protected virtual object EvalThenStatement(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }
