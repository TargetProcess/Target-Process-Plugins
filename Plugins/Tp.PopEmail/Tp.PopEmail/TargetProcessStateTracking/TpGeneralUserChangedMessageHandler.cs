...
{
    public class TpGeneralUserChangedMessageHandler
          ...
          IHandleMessages<RequesterUpdatedMessage>
    {
        ...
        {
            DeleteFromRepository(message.Dto.ID, message.Dto.Email);
        }
        ...
        private void DeleteFromRepository(int? userId, string userEmail)
        {
