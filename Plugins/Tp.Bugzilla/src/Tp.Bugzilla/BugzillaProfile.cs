...
namespace Tp.Bugzilla
{
    ...
    [DataContract]
    public class BugzillaProfile
        : ISynchronizableProfile, IValidatable, IBugTrackingMappingSource,
          IBugTrackingConnectionSettingsSource
    {
        ...
        public BugzillaProfile()
        {
            ...
            CustomMapping = new MappingContainer();
        }
        ...
        [DataMember]
        public MappingContainer CustomMapping { get; set; }
        ...
        {
            CustomMapping = (CustomMapping ?? new MappingContainer());
        }
        ...
        {
            if (RolesMapping.Any(x => string.IsNullOrEmpty(x.Value?.Name)))
            {
                errors.Add(new PluginProfileError
