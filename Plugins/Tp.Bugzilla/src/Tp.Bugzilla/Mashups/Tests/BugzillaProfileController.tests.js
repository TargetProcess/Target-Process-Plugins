    ...
    function (profileController) {
        module('test bugzilla profile controller', {
            setup: function () {
                ...
                this.controller._renderUserMappingControl = function () {
                   };
        ...
        test('should initialize and render view and mappings', function () {
            ...
            ok(retrievedProfile.Settings.SavedSearches == that.profile.Settings.SavedSearches, 'profile queries retrieved');
