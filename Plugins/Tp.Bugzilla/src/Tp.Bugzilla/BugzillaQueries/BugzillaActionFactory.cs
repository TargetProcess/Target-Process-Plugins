...
namespace Tp.Bugzilla.BugzillaQueries
{
    public class BugzillaActionFactory : IBugzillaActionFactory
    {
        ...
        public IBugzillaQuery GetCustomFieldAction(string bugzillaBugId, string customFieldName, string customFieldVaue)
        {
            return new BugzillaCustomFieldAction(bugzillaBugId, customFieldName, customFieldVaue);
        }
    ...
    public interface IBugzillaActionFactory
    {
        ...
        IBugzillaQuery GetCustomFieldAction(string bugzillaBugId, string customFieldName, string customFieldVaue);
    }
}
