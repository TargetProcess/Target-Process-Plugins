...
namespace Tp.SourceControl.Workflow.Workflow
{
    public abstract class VersionControlSystemProcessorBase
    {
        ...
        protected VersionControlSystemProcessorBase(IRevisionIdComparer revisionComparer, IStorageRepository storage,
            ISourceControlConnectionSettingsSource settingsSource, IVersionControlSystem versionControlSystem, ILocalBus bus,
        ...
        protected void SetStartRevisionBy(RevisionRange[] revisionRanges)
        {
            ...
            var processedRevisionRange = processedRevisionRangeStorage.SingleOrDefault()
                ?? new RevisionRange(newFromRevision, newToRevision);
