...
namespace Tp.Integration.Testing.Common
{
    ...
    {
        public static PropertyDescriptor[] ConvertTo(this CustomPropertyDescriptorInfo[] memento,
            Func<CustomPropertyDescriptorInfo, PropertyDescriptor> convertor)
        {
        ...
        public static CustomPropertyDescriptorInfo[] CreateMemento(this object instance)
        {
            ...
            var propertyInfos =
                instance.GetType().GetProperties(BindingFlags.Public | BindingFlags.Instance).Where(x => x.CanRead && x.CanWrite);
