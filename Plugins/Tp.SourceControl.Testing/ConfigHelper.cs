...
namespace Tp.SourceControl.Testing
{
    public class ConfigHelper
    {
        ...
        {
            get { return GetAppSettingsValue("TestCollectionWithMergeCommit", "http://localhost:8080/tfs/TestRepositoryWithMergeCommit"); }
        }

        public string TestProjectWithMergeCommit
        {
            get { return GetAppSettingsValue("TestProjectWithMergeCommit", "TestRepositoryWithMergeCommit"); }
        }

        public string TestCollectionWithFileDeleted
        {
            get { return GetAppSettingsValue("TestCollectionWithFileDeleted", "http://localhost:8080/tfs/TestCollectionWithFileDeleted"); }
        }

        public string TestProjectWithFileDeleted
        {
            get { return GetAppSettingsValue("TestProjectWithFileDeleted", "TestRepositoryWithFileDeleted"); }
        }

        public string FuncTestCollection
        {
            get { return GetAppSettingsValue("FuncTestCollection", "http://localhost:8080/tfs/functestscollection"); }
        }

        public string FuncTestsProject
        {
            get { return GetAppSettingsValue("FuncTestsProject", "FuncTestsProject"); }
        }
        ...
        public string Login
        {
            get { return "{0}\\{1}".Fmt(Environment.MachineName, GetAppSettingsValue("Login", "operator")); }
        }
