...
namespace Tp.Search.Tests
{
    ...
    public class SearchTests : SearchTestBase
    {
        ...
        public void SearchUserStoryByTeamAfterTeamUpdateToNull()
        {
            ...
            lastResult.AssignableIds.Should(
                Be.EquivalentTo(
                    expectedAssignablesIds.Take(1).Concat(new[] { assignableIdWithNullSquad }).Select(s => s.ToString()).ToArray()),
        ...
        public void SearchUserStoryByTeamAfterAddAssignableSquad()
        {
            ...
            result.Total.Should(Be.EqualTo(2), "result.Total.Should(Be.EqualTo(2))");
            result.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.True, "result.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.True)");
            ...
            newResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.True, "newResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.True)");
            ...
            lastResult.Total.Should(Be.EqualTo(1), "lastResult.Total.Should(Be.EqualTo(1))");
            lastResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.True, "lastResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.True)");
        }
        ...
        public void SearchUserStoryByTeamAfterUpdateAssignableSquad()
        {
            ...
            newResult.Total.Should(Be.EqualTo(1), "newResult.Total.Should(Be.EqualTo(1))");
            newResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.False, "newResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.False)");
        ...
        public void SearchUserStoryByMultipleTeamsAfterChange()
        {
            ...
            targetResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.True, "targetResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.True)");
            ...
            anotherResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.True, "anotherResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.True)");
            ...
            oldResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.False, "oldResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.False)");
            ...
            anotherStillResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.True, "anotherStillResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.True)");
            ...
            updatedResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.True, "updatedResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.True)");
        }
        ...
        public void SearchUserStoryByNoTeamAfterChangeAssignableSquad()
        {
            ...
            noTeamResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.False, "noTeamResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.False)");
            ...
            teamResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.True, "teamResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.True)");
            ...
            updatedNoTeamResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.False, "updatedNoTeamResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.False)");
            ...
            updatedTeamResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.False, "updatedTeamResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.False)");
            ...
            anotherTeamResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.True, "anotherTeamResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.True)");
            ...
            lastNoTeamResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.True, "lastNoTeamResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.True)");
            ...
            lastTeamResult.AssignableIds.Contains(expectedAssignableId.ToString())
                .Should(Be.False, "lastTeamResult.AssignableIds.Contains(expectedAssignableId.ToString()).Should(Be.False)");
        }
        ...
        public void SearchUserStoryByTeamAfterProjectUpdateToNull()
        {
            ...
            lastResult.AssignableIds.Should(
                Be.EquivalentTo(
                    expectedAssignablesIds.Take(1).Concat(new[] { assignableIdWithNullProject }).Select(s => s.ToString()).ToArray()),
        ...
        public void SearchCommentByMultipleTeams()
        {
            ...
            targetResult.CommentIds.Should(
                Be.EquivalentTo(new[] { expectedCommentId, anotherCommentId }.Select(s => s.ToString()).ToArray()),
                "targetResult.CommentIds.Should(Be.EquivalentTo(new[] { expectedCommentId, anotherCommentId }.Select(s => s.ToString()).ToArray()))");
            ...
            anotherQueryResult.CommentIds.Should(Be.EquivalentTo(new[] { expectedCommentId }.Select(s => s.ToString()).ToArray()),
                "anotherQueryResult.CommentIds.Should(Be.EquivalentTo(new[] { expectedCommentId }.Select(s => s.ToString()).ToArray()))");
        }
        ...
        public void ShouldNotSearchCommentIfEntityStateSelected()
        {
            ...
            entityWithComments.AssignableIds.Should(Be.EquivalentTo(new[] { 1 }.Select(x => x.ToString()).ToArray()),
                "entityWithComments.AssignableIds.Should(Be.EquivalentTo(new[]{{i}}.Select(x => x.ToString()).ToArray()))");
