...
namespace Tp.Search.Tests
{
	...
	public class SearchTestBase
	{
		...
		private void ClearIndexes()
		{
			...
			GetInstance<IDocumentIndexProvider>().ShutdownDocumentIndexes(new PluginContextSnapshot(GetInstance<IPluginContext>()), new DocumentIndexShutdownSetup(forceShutdown: true, cleanStorage: true), logger);
		}
