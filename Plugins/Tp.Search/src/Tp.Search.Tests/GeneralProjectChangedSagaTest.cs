...
namespace Tp.Search.Tests
{
    ...
    class GeneralProjectChangedSagaTest : SearchTestBase
    {
        ...
        {
            base.OnSetup();
            _transport = TransportMock.CreateWithoutStructureMapClear(typeof(SearcherProfile).Assembly,
                new[] { typeof(SearcherProfile).Assembly }, new Assembly[] { });
            _generals = new[]
            {
                new GeneralDTO
                {
            ...
            _transport.On<ImpedimentQuery>()
                .Reply(
                    x =>
                        new ImpedimentQueryResult
                        {
                            Dtos = new ImpedimentDTO[] { },
                            QueryResultCount = 0,
                            TotalQueryResultCount = 0,
                            FailedDtosCount = 0
                        });
            _transport.On<ReleaseProjectQuery>()
                .Reply(
                    x =>
                        new ReleaseProjectQueryResult
                        {
                            Dtos = new ReleaseProjectDTO[] { },
                            QueryResultCount = 0,
                            TotalQueryResultCount = 0,
                            FailedDtosCount = 0
                        });
            _transport.On<RetrieveAllAssignableSquadsQuery>()
                .Reply(
                    x =>
                        new AssignableSquadQueryResult
                        {
                            Dtos = new AssignableSquadDTO[] { },
                            QueryResultCount = 0,
                            TotalQueryResultCount = 0,
                            FailedDtosCount = 0
                        });
        ...
        public void ShouldUpdateCommentProjectIndexWhenProjectChanged()
        {
            ...
            queryRunner.Run(new QueryData
                ...
                .Total.Should(Be.EqualTo(0),
                    "queryRunner.Run(new QueryData{Query = \"Description\",EntityTypeId = QueryEntityTypeProvider.COMMENT_TYPE_ID,ProjectIds = new[] { 1 }}).Total.Should(Be.EqualTo(0))");
            ...
            queryRunner.Run(new QueryData
                ...
                .Total.Should(Be.EqualTo(1),
                    "queryRunner.Run(new QueryData{Query = \"Description\",EntityTypeId = QueryEntityTypeProvider.COMMENT_TYPE_ID,ProjectIds = new[] { 2 }}).Total.Should(Be.EqualTo(1))");
        }
        ...
        public void ShouldUpdateTestStepProjectIndexWhenProjectChanged()
        {
            ...
            queryRunner.Run(new QueryData
                ...
                .Total.Should(Be.EqualTo(0),
                    "queryRunner.Run(new QueryData{Query = \"First Test Step\",EntityTypeId = QueryEntityTypeProvider.TESTCASE_TYPE_ID,ProjectIds = new[] { 1 }}).Total.Should(Be.EqualTo(0))");
            ...
            queryRunner.Run(new QueryData
                ...
                .Total.Should(Be.EqualTo(1),
                    "queryRunner.Run(new QueryData{Query = \"First Test Step\",EntityTypeId = QueryEntityTypeProvider.TESTCASE_TYPE_ID,ProjectIds = new[] { 2 }}).Total.Should(Be.EqualTo(1))");
        }
        ...
        public void ShouldUpdateCommentProjectIndexWhenAssignChangeReleaseProject()
        {
            ...
            queryRunner.Run(new QueryData
                ...
                .Total.Should(Be.EqualTo(1),
                    "queryRunner.Run(new QueryData{Query = \"Description\",EntityTypeId = QueryEntityTypeProvider.COMMENT_TYPE_ID,ProjectIds = new[] { 1 }}).Total.Should(Be.EqualTo(1))");
            ...
            queryRunner.Run(new QueryData
                ...
                .Total.Should(Be.EqualTo(0),
                    "queryRunner.Run(new QueryData{Query = \"Description\",EntityTypeId = QueryEntityTypeProvider.COMMENT_TYPE_ID,ProjectIds = new[] { 2 }}).Total.Should(Be.EqualTo(0))");
        }
    }
}
