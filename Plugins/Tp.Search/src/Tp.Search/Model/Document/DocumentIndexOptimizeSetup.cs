namespace Tp.Search.Model.Document
{
    ...
    {
        public static readonly DocumentIndexOptimizeSetup DeferredOptimize = new DocumentIndexOptimizeSetup(shouldOptimize: true,
            shouldDefer: true, shouldFreeMemory: true);

        public static readonly DocumentIndexOptimizeSetup ImmediateOptimize = new DocumentIndexOptimizeSetup(shouldOptimize: true,
            shouldDefer: false, shouldFreeMemory: true);

        public static readonly DocumentIndexOptimizeSetup NoOptimize = new DocumentIndexOptimizeSetup(shouldOptimize: false,
            shouldDefer: true, shouldFreeMemory: true);
