...
namespace Tp.Search.Model.Document
{
	class DocumentIndex : IDocumentIndex
	{
		...
		public DocumentIndexType Type { get { return _charactersIndex.Type; } }

		public bool IsAlive { get { return _charactersIndex.IsAlive && _numberIndex.IsAlive; }}
		public bool IsOptimized { get { return _charactersIndex.IsOptimized && _numberIndex.IsOptimized; } }
