...
namespace Tp.Search.Model.Document
{
	class DocumentIndexMonitor : IDocumentIndex, ILock
	{
        ...
        public bool IsOptimized { get { return _documentIndex != null ? _documentIndex.IsOptimized : true; } }
		public DocumentIndexTypeToken Token { get { return Type.TypeToken; } }
		public DocumentIndexType Type { get { return _documentIndexType; } } 
