...
namespace Tp.Search.Model.Query
{
    class ImpedimentContextQueryPlanBuilder : IContextQueryPlanBuilder
    {
        ...
        public ImpedimentContextQueryPlanBuilder(IProjectContextQueryPlanBuilder plansBuilder, IProfileReadonly profile,
            IIndexDataFactory indexDataFactory, IDocumentIndexProvider documentIndexProvider, IPluginContext pluginContext,
        ...
        public Maybe<QueryPlan> Build(QueryData data, DocumentIndexTypeToken projectContextType, DocumentIndexTypeToken _,
            DocumentIndexTypeToken __)
        {
            var query = _indexDataFactory.CreateImpedimentData(false, data.LoggedUserId, data.LoggedUserId);
            IDocumentIndex impedimentContextIndex = _documentIndexProvider.GetOrCreateDocumentIndex(_pluginContext,
