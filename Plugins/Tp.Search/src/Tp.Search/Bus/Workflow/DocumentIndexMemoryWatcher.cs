...
namespace Tp.Search.Bus.Workflow
{
    class DocumentIndexMemoryWatcher : IHandleMessages<TickMessage>
    {
        ...
        public DocumentIndexMemoryWatcher(IPluginContext pluginContext, IProfileReadonly profile,
            IDocumentIndexProvider documentIndexProvider, DocumentIndexSetup documentIndexSetup, IActivityLogger logger)
        {
