...
namespace Tp.Search.Bus.Workflow
{
    class DocumentIndexOptimizer : IHandleMessages<TickMessage>
    {
        ...
        public DocumentIndexOptimizer(IPluginContext pluginContext, IProfileReadonly profile, IDocumentIndexProvider documentIndexProvider,
            DocumentIndexSetup documentIndexSetup, DocumentIndexPeriodicOptimizeHintFactory optimizeHintFactory, IActivityLogger logger)
        {
