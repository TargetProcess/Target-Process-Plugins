...
namespace hOOt
{
    public class Hoot
    {
        public Hoot(string indexPath, string fileName, Action<string> log, Action<string> logError, ITokensParser tokensParser,
        ...
        public void OptimizeIndex(bool freeCache)
        {
            ...
            lock (_lock)
            {
                ...
                _bitmapFile = new FileStream(_path + _fileName + ".bitmap$", FileMode.OpenOrCreate, FileAccess.ReadWrite,
                    FileShare.ReadWrite);
