...
namespace Tp.Search.Model.Document
{
	class DocumentIndexes
	{
		...
		private readonly IEnumerable<DocumentIndexTypeToken> _documentTypes;
		...
		public DocumentIndexes()
		{
			...
			_documentTypes = Enum.GetValues(typeof(DocumentIndexTypeToken)).Cast<DocumentIndexTypeToken>().ToList();
		}
		...
		public IEnumerable<DocumentIndexTypeToken> DocumentTypes
		{
