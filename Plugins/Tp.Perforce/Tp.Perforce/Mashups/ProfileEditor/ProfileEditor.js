tau.mashups
    .addDependency("Perforce/UserMappingEditor")
    .addDependency("tp/bus")
    .addDependency("tp/plugins/profileControlsBlock")
    .addDependency("libs/jquery/jquery")
    .addModule("Perforce/PerforceProfileEditor", function (UserMappingEditor, Bus, profileControlsBlock, $) {

        function PerforceProfileEditor(config) {
            this._create(config);
        }

        PerforceProfileEditor.prototype = {
            template: null,
            placeHolder: null,
            saveBtn: null,
            preloader: null,
            ...
            '		Perforce Plugin</h2>' +
            '	<p class="note">' +
            '		Exports revisions from Perforce and binds source code to TargetProcess user stories, bugs and tasks.</p>' +
            ...
            '			<p class="label">' +
            '				Enter a full path to the repository&nbsp;<span class="small">(example: perforce:1666)</span>&nbsp;<span class="error" name="UriErrorLabel"></span></p>' +
            ...
            '			<p class="label pt-10">' +
            '				Workspace&nbsp;<span class="error" name="WorkspaceErrorLabel"></span></p>' +
            '			<input type="text" class="input" id="workspace" name="Workspace" value="${Settings.Workspace}" style="width: 275px;" />' +
            '			<p class="label pt-20">' +
            ...
            _create: function (config) {
                ...
                Bus.subscribe("PerforceProfileEditor", {
            ...
            _getProfileFromEditor: function () {
                return {
                    ...
                    Settings: {
                        ...
                        Workspace: this._find('#workspace').val(),
