tau.mashups
    ...
    .addModule("Perforce/UserMappingEditor", function (userRepository, restService, Bus, usersPopoverWidget) {
	    ...
	    UserMappingEditor.prototype = {
	        ...
	        _completeRendering: function () {
	            ...
	            this.rendered.find(".automapping .tau-btn").click($.proxy(this._onAutomapping, this));
