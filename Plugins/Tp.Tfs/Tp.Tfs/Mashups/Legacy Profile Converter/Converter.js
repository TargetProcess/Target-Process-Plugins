tau.mashups
    ...
    .addMashup(function (commandGateway, $, config) {
        ...
        var initConvertLinks = function() {
            ...
            while (tfsParent != null && tableParent == null) {
            ...
            $.each(profilesTable.find('tr'), function(i, el) {
                ...
                var convertLink = $('<a class="button smaller primary mr-5" title="Convert to new profile" href="javascript:void(0);">Convert to new profile</a>');
