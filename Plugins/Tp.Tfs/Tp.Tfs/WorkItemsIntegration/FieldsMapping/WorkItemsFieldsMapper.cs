...
namespace Tp.Tfs.WorkItemsIntegration.FieldsMapping
{
	public class WorkItemsFieldsMapper
	{
		...
		private readonly Dictionary<string, Dictionary<string, NamesPair[]>> _mapping = new Dictionary<string, Dictionary<string, NamesPair[]>>
    {
        {
            Constants.TfsBug, 
            new Dictionary<string, NamesPair[]>
                {
                    ...
                    {"Description", new [] { new NamesPair("Repro Steps", "Steps To Reproduce"), new NamesPair("Acceptance Criteria", "Acceptance Criteria") }}
                }
        }, 
        {
        ...
        },
        {
            ...
            new Dictionary<string, NamesPair[]>
                {
                    {"Name", new [] { new NamesPair("Title", "Title") }}, 
                    {"Description", new [] { new NamesPair("Description", "Description"), new NamesPair("Acceptance Criteria", "Acceptance Criteria") }}
                }
        },
        {
            ...
            new Dictionary<string, NamesPair[]>
                {
                    {"Name", new [] { new NamesPair("Title", "Title") }}, {"Description", new [] { new NamesPair("Description", "Description") }}
                }
        }
    };
