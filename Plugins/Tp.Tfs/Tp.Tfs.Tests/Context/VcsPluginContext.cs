...
namespace Tp.Tfs.Tests.Context
{
	public class VcsPluginContext
	{
		...
		private TfsPluginProfile _profile;
        ...
        public TfsPluginProfile Profile
		{
            get { return _profile ?? (_profile = ProfileStorage.GetProfile<TfsPluginProfile>()); }
		}
				                      		...
				                      		return new UserDTO
				                      			{
				                      				...
				                      				IsActive = true,
				                      				Email = u.Email,
                                                    ActiveDirectoryName = "someone_active_dir"
				                      			};
				                      	}).ToArray();
			}
		}
		...
		private IProfileReadonly ProfileStorage
		{
            ...
            { 
                return _profileStorage ?? 
                    (_profileStorage = _transport.AddProfile(
                        "Test profile", 
                        new TfsPluginProfile { StartRevision = "1", Uri = ConfigHelper.Instance.TestCollection })); 
            }
		}
		...
		{
			var userLookup = new TpUserMappingInfo { Id = EntityId.Next(), Name = userName, Login = userLogin };
			TpUsers.Add(userLookup);
		}
