    ...
    public class TfsRevisionIdComparerSpecs
    {
        ...
        public void ShouldFindMinFromRevision()
        {
            ((TfsRevisionId) _comparer.FindMinFromRevision(_revisionRanges)).Time.Should(
                ...
                "((TfsRevisionId)_comparer.FindMinFromRevision(_revisionRanges)).Time.Should( Be.EqualTo(((TfsRevisionId)_revisionRanges[3].FromChangeset).Time))");
        }
        ...
        public void ShouldFindMaxToRevision()
        {
            ((TfsRevisionId) _comparer.FindMaxToRevision(_revisionRanges)).Time.Should(
                ...
                "((TfsRevisionId)_comparer.FindMaxToRevision(_revisionRanges)).Time.Should( Be.EqualTo(((TfsRevisionId)_revisionRanges[2].ToChangeset).Time))");
        }
