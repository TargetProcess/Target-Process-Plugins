...
namespace Tp.Tfs.Tests.RevisionStorageTests
{
    [TestFixture]
    [Category("PartPlugins1")]
    public class TfsRevisionStorageRepositoryTests
    {
        [Test]
        ...
        {
            var revisionInfoKey = new TfsRevisionStorageRepository(null, null).GetRevisionInfoKey(new RevisionInfo
            {
                Author = "User1",
