...
namespace Tp.Mercurial.Tests
{
    ...
    public class ModelsTest
    {
        ...
        public void ValidateCredentialsInUriTest()
        {
            ...
            uri.Should(Be.EqualTo("https://vanya:123456@server.com"), "uri.Should(Be.EqualTo(\"https://vanya:123456@server.com\"))");
        }
        ...
        public void ValidateCredentialsInUriWithoutPasswordTest()
        {
            ...
            uri.Should(Be.EqualTo("https://vanya@server.com"), "uri.Should(Be.EqualTo(\"https://vanya@server.com\"))");
        }
        ...
        public void ValidateCredentialsInUriWithLoginSubstringTest()
        {
            ...
            uri.Should(Be.EqualTo("https://vanya:123456@server.com/vanya"), "uri.Should(Be.EqualTo(\"https://vanya:123456@server.com/vanya\"))");
        }
