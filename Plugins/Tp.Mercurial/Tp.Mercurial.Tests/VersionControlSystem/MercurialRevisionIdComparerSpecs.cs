    ...
    public class MercurialRevisionIdComparerSpecs
    {
        ...
        public void ShouldFindMinFromRevision()
        {
            ((MercurialRevisionId) _comparer.FindMinFromRevision(_revisionRanges)).Time.Should(
                ...
                "((MercurialRevisionId)_comparer.FindMinFromRevision(_revisionRanges)).Time.Should( Be.EqualTo(((MercurialRevisionId)_revisionRanges[3].FromChangeset).Time))");
        }
        ...
        public void ShouldFindMaxToRevision()
        {
            ((MercurialRevisionId) _comparer.FindMaxToRevision(_revisionRanges)).Time.Should(
                ...
                "((MercurialRevisionId)_comparer.FindMaxToRevision(_revisionRanges)).Time.Should( Be.EqualTo(((MercurialRevisionId)_revisionRanges[2].ToChangeset).Time))");
        }
