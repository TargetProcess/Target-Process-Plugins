...
namespace Tp.TestRunImport.LegacyProfileConversion
{
    ...
    {
        protected TestRunImportLegacyProfileConvertor(IConvertorArgs args, IAccountCollection accountCollection)
        ...
        protected override void OnProfileMigrated(IStorageRepository storageRepository, PluginProfile legacyProfile)
        {
            ...
            {
                storageRepository.Get<LastModifyResult>()
                    .Add(new LastModifyResult { ModifyTimeUtcsTicks = TestResultFileLastModifyTimeUtc.Ticks });
            }
