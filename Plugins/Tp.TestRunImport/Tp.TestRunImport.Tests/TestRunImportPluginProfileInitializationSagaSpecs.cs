...
namespace Tp.TestRunImport.Tests
{
	...
	public class TestRunImportPluginProfileInitializationSagaSpecs
	{
		...
		private static readonly TestCaseTestPlanDTO CaseTestPlanDto1 = new TestCaseTestPlanDTO { TestCaseName = "Test Case 1", TestPlanID = 4, ID = 1 };
		private static readonly TestCaseTestPlanDTO CaseTestPlanDto2 = new TestCaseTestPlanDTO { TestCaseName = "Test Case 2", TestPlanID = 4, ID = 2 };
		private static readonly TestCaseTestPlanDTO CaseTestPlanDto3 = new TestCaseTestPlanDTO { TestCaseName = "Test Case 3", TestPlanID = 4, ID = 3 };
