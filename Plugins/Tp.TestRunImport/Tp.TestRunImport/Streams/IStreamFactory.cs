...
namespace Tp.Integration.Plugin.TestRunImport.Streams
{
	...
	public interface IStreamFactory
	{
		...
		/// </exception>
		StreamFactoryResult OpenStream(Uri uri, bool passiveMode);
		...
		/// If any input/output error occurs.
		/// </exception>
		StreamFactoryResult OpenStreamIfModified(Uri uri, LastModifyResult lastModifyResult, bool passiveMode);
	}
}