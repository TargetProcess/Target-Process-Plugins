...
namespace Tp.LegacyProfileConvertsion.Common
{
    ...
    public class CmdLine
    {
        ...
        public string HelpScreen()
        {
            ...
            help +=
                "Usage example: LegacyProfileConverter.exe -acc EMPTY -tpdb \"Server=(local);initial catalog=TargetProcess;Integrated Security=SSPI;Connection Timeout=3600\" -plugindb \"Server=(local);initial catalog=TargetProcess.Plugins;Integrated Security=SSPI;Connection Timeout=3600\"";
