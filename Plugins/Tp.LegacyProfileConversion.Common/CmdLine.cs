...
namespace Tp.LegacyProfileConvertsion.Common
{
	...
	public class CmdLine
	{
		...
		public string HelpScreen()
		{
			...
			help +=
				"Usage example: LegacyProfileConverter.exe -acc EMPTY -tpdb \"Server=(local);initial catalog=TargetProcess;user id=sa;password=sa;Connection Timeout=3600\" -plugindb \"Server=(local);initial catalog=TargetProcess.Plugins;user id=sa;password=sa;Connection Timeout=3600\"";
