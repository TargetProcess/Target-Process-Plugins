...
namespace Tp.LegacyProfileConvertsion.Common
{
    ...
    partial void OnWorkflowIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Workflow_EntityState", Storage="_Workflow", ThisKey="WorkflowID", OtherKey="WorkflowID", IsForeignKey=true)]
    ...
    partial void OnDescriptionChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Process_Workflow", Storage="_Workflows", ThisKey="ProcessID", OtherKey="ProcessID")]
	...
	public partial class Workflow : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _ParentWorkflowID;
		...
		private EntityRef<Workflow> _Workflow1;
    ...
    partial void OnWorkflowIDChanged();
    partial void OnParentWorkflowIDChanging(System.Nullable<int> value);
    ...
    partial void OnNameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ParentWorkflowID", DbType="Int")]
		public System.Nullable<int> ParentWorkflowID
		{
			get
			{
			...
			set
			{
				if ((this._ParentWorkflowID != value))
				{
					if (this._Workflow1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					...
					this.SendPropertyChanged("ParentWorkflowID");
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Workflow_Workflow", Storage="_Workflows", ThisKey="WorkflowID", OtherKey="ParentWorkflowID")]
		public EntitySet<Workflow> Workflows
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Workflow_EntityState", Storage="_EntityStates", ThisKey="WorkflowID", OtherKey="WorkflowID")]
		public EntitySet<EntityState> EntityStates
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Workflow_Workflow", Storage="_Workflow1", ThisKey="ParentWorkflowID", OtherKey="WorkflowID", IsForeignKey=true)]
		public Workflow Workflow1
		{
			get
			{
				return this._Workflow1.Entity;
			}
			set
			{
				Workflow previousValue = this._Workflow1.Entity;
				if (((previousValue != value) 
							|| (this._Workflow1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Workflow1.Entity = null;
						previousValue.Workflows.Remove(this);
					}
					this._Workflow1.Entity = value;
					if ((value != null))
					{
						value.Workflows.Add(this);
						this._ParentWorkflowID = value.WorkflowID;
					}
					else
					{
						this._ParentWorkflowID = default(Nullable<int>);
					}
					this.SendPropertyChanged("Workflow1");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Process_Workflow", Storage="_Process", ThisKey="ProcessID", OtherKey="ProcessID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Process Process
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.Workflow1 = this;
		}
		
		private void detach_Workflows(Workflow entity)
		{
			this.SendPropertyChanging();
			entity.Workflow1 = null;
		}
