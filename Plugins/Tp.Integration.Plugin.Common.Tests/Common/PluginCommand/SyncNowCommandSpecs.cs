    ...
    public class SyncNowCommandSpecs
    {
        ...
        public void SyncShouldBeStarted(string profileName)
        {
            ...
            ObjectFactory.GetInstance<TransportMock>().LocalQueue.GetMessageInfos<TickMessage>().Single(
                ...
                .Should(Be.Not.Null,
                    "ObjectFactory.GetInstance<TransportMock>().LocalQueue.GetMessageInfos<TickMessage>().Single(x => x.ProfileName == profileName).Should(Be.Not.Null)");
        }
        ...
        public void CheckSuccessStatus()
        {
            ObjectFactory.GetInstance<TransportMock>().TpQueue.GetMessages<PluginCommandResponseMessage>().Last().
                PluginCommandStatus.Should(Be.EqualTo(PluginCommandStatus.Succeed),
                    "ObjectFactory.GetInstance<TransportMock>().TpQueue.GetMessages<PluginCommandResponseMessage>().Last().PluginCommandStatus.Should(Be.EqualTo(PluginCommandStatus.Succeed))");
        }
        ...
        public void CheckFailStatus()
        {
            ObjectFactory.GetInstance<TransportMock>().TpQueue.GetMessages<PluginCommandResponseMessage>().Last().
                PluginCommandStatus.Should(Be.EqualTo(PluginCommandStatus.Error),
                    "ObjectFactory.GetInstance<TransportMock>().TpQueue.GetMessages<PluginCommandResponseMessage>().Last().PluginCommandStatus.Should(Be.EqualTo(PluginCommandStatus.Error))");
        }
        ...
        public void CheckLastSyncDate(string profileName)
        {
            ObjectFactory.GetInstance<IStorageRepository>()
                .Get<LastSyncDate>()
                .First()
                .Should(Be.Not.Null, "ObjectFactory.GetInstance<IStorageRepository>().Get<LastSyncDate>().First().Should(Be.Not.Null)");
        }
    }
}
