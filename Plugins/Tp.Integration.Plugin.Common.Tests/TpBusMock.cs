...
namespace Tp.Integration.Plugin.TaskCreator.Tests
{
    public class TpBusMock : ITpBus
    {
        ...
        private readonly List<IMessage> _pluginCommands = new List<IMessage>();
        ...
        public List<IMessage> PluginCommands
        {
        ...
        {
            _pluginCommands.Add(message);
        }

        public void Send(params IPluginLifecycleMessage[] pluginLifecycleMessages)
        {
            _pluginCommands.AddRange(pluginLifecycleMessages);
        }
