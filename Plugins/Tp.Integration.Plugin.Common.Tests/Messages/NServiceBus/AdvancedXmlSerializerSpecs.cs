...
namespace Tp.Integration.Plugin.Common.Tests.Messages.NServiceBus
{
    ...
    public class AdvancedXmlSerializerSpecs
    {
        ...
        public void ShouldSerializeDateTime()
        {
            ...
            ((DateTimeMessage) deserialized[0]).CreateDate.ToString()
        ...
        {
            const string oldSerializedMessage =
            ...
            ((UserStoryCreatedMessage[]) deserialized).Single()
                .Dto.CustomFieldsMetaInfo.Should(Be.Null,
