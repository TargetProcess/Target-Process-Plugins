...
namespace Tp.Git.Tests.Context
{
	public class VcsPluginContext
	{
		...
		public GitPluginProfile Profile
		{
			get { return _profile ?? (_profile = ProfileStorage.GetProfile<GitPluginProfile>()); }
		}
		...
		{
			get { return _profileStorage ?? (_profileStorage = _transport.AddProfile("Test profile", new GitPluginProfile { StartRevision = "1/1/1980", Uri = "http://localhost" })); }
		}
