...
namespace Tp.Git.Commands
{
    public class RescanRepositoryCommand : IPluginCommand
    {
        ...
        public PluginCommandResponseMessage Execute(string _, UserDTO user)
        {
            ...
            return new PluginCommandResponseMessage { PluginCommandStatus = PluginCommandStatus.Succeed, ResponseData = string.Empty.Serialize() };
        }

        public string Name => "RescanRepository";
    }
}
