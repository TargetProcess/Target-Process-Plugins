require(["tp/plugins/vcs/SubversionProfileEditorDefaultController", "Subversion/SubversionProfileEditor"], function (SubversionProfileEditorDefaultController, SubversionProfileEditor) {
    module('show plugin profile tests', {
        setup: function () {
            ...
            this._createEditor = function (model) {
                return new SubversionProfileEditor({
