...
namespace Tp.Subversion.SerializationPatches.Xml
{
    public class RevisionRangeInStoragePatch : IPatch
    {
        ...
        {
            return text.Replace(">Tp.Subversion.VersionControlSystem.RevisionRange, Tp.Subversion<",
                    ">Tp.SourceControl.VersionControlSystem.RevisionRange, Tp.SourceControl<")
