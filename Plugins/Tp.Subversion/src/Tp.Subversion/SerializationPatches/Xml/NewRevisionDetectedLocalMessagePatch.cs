...
namespace Tp.Subversion.SerializationPatches.Xml
{
	public class NewRevisionDetectedLocalMessagePatch : IPatch
	{
		...
		{
			return text.Replace(">Tp.Subversion.Messages.NewRevisionDetectedLocalMessage<", ">Tp.SourceControl.Messages.NewRevisionDetectedLocalMessage<")
				...
				.Replace(">Tp.Subversion.VersionControlSystem.RevisionEntryInfo<", ">Tp.SourceControl.VersionControlSystem.RevisionEntryInfo<")
				.Replace(">Tp.Subversion.VersionControlSystem.RevisionEntryInfo[]<", ">Tp.SourceControl.VersionControlSystem.RevisionEntryInfo[]<");
		}
	}
}