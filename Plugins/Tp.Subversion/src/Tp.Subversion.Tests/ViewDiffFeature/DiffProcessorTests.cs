...
namespace Tp.Subversion.ViewDiffFeature
{
	...
	public class DiffProcessorTests
	{
		...
		public void TestStringUpdate()
		{
			...
			leftSecondString.Action.Should(Be.EqualTo(DiffActionType.Updated), "leftSecondString.Action.Should(Be.EqualTo(DiffActionType.Updated))");
			...
			rightSecondString.Action.Should(Be.EqualTo(DiffActionType.Updated), "rightSecondString.Action.Should(Be.EqualTo(DiffActionType.Updated))");
