...
namespace Tp.Subversion.ViewDiffFeature
{
    ...
    public class DiffTests
    {
        ...
        public void TestAllChanges()
        {
            ...
            ConvertToString(Diff.DiffText(a, b, false, false, false))
                .Should(Be.EqualTo("12.10.0.0*"),
        ...
        public void TestAllSame()
        {
            ...
            ConvertToString(Diff.DiffText(a, b, false, false, false))
                .Should(Be.Empty, "ConvertToString(Diff.DiffText(a, b, false, false, false)).Should(Be.Empty)");
        }
        ...
        public void TestSnake()
        {
            ...
            ConvertToString(Diff.DiffText(a, b, false, false, false))
                .Should(Be.EqualTo("1.0.0.0*0.1.6.5*"),
        ...
        public void TestRepro20020920()
        {
            ...
            ConvertToString(Diff.DiffText(a, b, false, false, false))
                .Should(Be.EqualTo("1.1.0.0*1.1.2.2*0.2.7.7*1.1.11.13*0.1.13.15*"),
        ...
        public void TestRepro20030207()
        {
            ...
            ConvertToString(Diff.DiffText(a, b, false, false, false))
                .Should(Be.EqualTo("0.1.0.0*0.7.1.2*"),
        ...
        public void TestRepro20030409()
        {
            ...
            ConvertToString(Diff.DiffText(a, b, false, false, false))
                .Should(Be.EqualTo("2.8.0.0*"), "ConvertToString(Diff.DiffText(a, b, false, false, false)).Should(Be.EqualTo(\"2.8.0.0*\"))");
        }
        ...
        public void TestSomeDifferences()
        {
            ...
            ConvertToString(Diff.DiffText(a, b, false, false, false))
                .Should(Be.EqualTo("1.1.2.2*1.0.4.4*1.0.6.5*"),
