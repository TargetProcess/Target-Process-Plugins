...
namespace Tp.Integration.Common
{
	...
	public partial class TestPlanDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? TestPlanID { get; set; }
		...
		[DataMember][XmlElement(Order = 72)]public Decimal? InitialEstimate { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 76)]public Int32? ProjectID { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 78)]public virtual string ProjectName { get; set; }
