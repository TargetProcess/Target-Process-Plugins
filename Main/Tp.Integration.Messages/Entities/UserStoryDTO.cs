...
namespace Tp.Integration.Common
{
	...
	public partial class UserStoryDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[XmlElement(Order = 3)]public int? UserStoryID { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 43)]public virtual string EntityTypeName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 44)]public virtual string EntityStateName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 45)]public virtual string PriorityName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 46)]public virtual string ProjectName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 47)]public virtual string IterationName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 48)]public virtual string ParentName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 49)]public virtual string ReleaseName { get; set; }
