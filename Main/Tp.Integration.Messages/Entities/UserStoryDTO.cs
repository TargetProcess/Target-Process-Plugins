...
{
    /// <summary>
    /// Data Transfer object of User Story. Represents User Story.
    /// </summary>
	...
	public partial class UserStoryDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? UserStoryID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 84)]public Int32? IterationID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 86)]public Int32? ReleaseID { get; set; }
		
		/// <summary>
        /// Gets or sets the Feature ID. Reference to the feature
        /// </summary>
        /// <value>The Feature ID.</value>
		[ForeignKey]
		[DataMember][XmlElement(Order = 87)]public Int32? FeatureID { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 88)]public virtual string EntityTypeName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 89)]public virtual string EntityStateName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 90)]public virtual string PriorityName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 91)]public virtual string ProjectName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 92)]public virtual string IterationName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 93)]public virtual string ParentName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 94)]public virtual string ReleaseName { get; set; }
		
		/// <summary>
        /// Gets or sets the Feature Name. Reference to the feature
        /// </summary>
        /// <value>The Feature Name.</value>
		[RelationName]
		[DataMember][XmlElement(Order = 95)]public virtual string FeatureName { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 96)]public Int32? EntityTypeID { get; set; }
