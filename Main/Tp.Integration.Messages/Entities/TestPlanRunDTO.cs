...
namespace Tp.Integration.Common
{
	...
	public partial class TestPlanRunDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[XmlElement(Order = 3)]public int? TestPlanRunID { get; set; }
		...
		[XmlElement(Order = 32)]public Int32? FailedCount { get; set; }

		/// <summary>
        /// Gets or sets the Passed Count. Passed Count
        /// </summary>
        /// <value>The Passed Count.</value>
		[XmlElement(Order = 33)]public Int32? PassedCount { get; set; }

		/// <summary>
        /// Gets or sets the Not Run Count. Not Run Count
        /// </summary>
        /// <value>The Not Run Count.</value>
		[XmlElement(Order = 34)]public Int32? NotRunCount { get; set; }
		...
		[ForeignKey]
		[XmlElement(Order = 44)]public Int32? TestPlanID { get; set; }
		...
		[ForeignKey]
		[XmlElement(Order = 45)]public Int32? BuildID { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 46)]public virtual string EntityTypeName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 47)]public virtual string EntityStateName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 48)]public virtual string PriorityName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 49)]public virtual string ProjectName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 50)]public virtual string IterationName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 51)]public virtual string ParentName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 52)]public virtual string ReleaseName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 53)]public virtual string TestPlanName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 54)]public virtual string BuildName { get; set; }
		...
		[ForeignKey]
		[XmlElement(Order = 55)]public Int32? EntityTypeID { get; set; }
	}
