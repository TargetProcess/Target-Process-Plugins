...
{
    /// <summary>
    /// Data Transfer object of Test Plan Run. Represents Test Plan Run.
    /// </summary>
	[Serializable][DataContract]
	public partial class TestPlanRunDTO : DataTransferObject
	{
        /// <summary>
        /// Gets or sets the ID.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the Test Plan Run ID.
        /// </summary>
        /// <value>The Test Plan Run ID.</value>
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? TestPlanRunID { get; set; }
		...
		/// <summary>
        /// Gets or sets the Failed Count. Failed Count
        /// </summary>
        /// <value>The Failed Count.</value>
		[DataMember][XmlElement(Order = 77)]public Int32? FailedCount { get; set; }

		/// <summary>
        /// Gets or sets the Passed Count. Passed Count
        /// </summary>
        /// <value>The Passed Count.</value>
		[DataMember][XmlElement(Order = 78)]public Int32? PassedCount { get; set; }

		/// <summary>
        /// Gets or sets the Not Run Count. Not Run Count
        /// </summary>
        /// <value>The Not Run Count.</value>
		[DataMember][XmlElement(Order = 79)]public Int32? NotRunCount { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 80)]public Int32? LastCommentUserID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 81)]public Int32? OwnerID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 82)]public Int32? LastEditorID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 83)]public Int32? EntityStateID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 84)]public Int32? PriorityID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 85)]public Int32? ProjectID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 86)]public Int32? IterationID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 87)]public Int32? ParentID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 88)]public Int32? ReleaseID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 89)]public Int32? TestPlanID { get; set; }

		/// <summary>
        /// Gets or sets the Build ID. Reference to Build
        /// </summary>
        /// <value>The Build ID.</value>
		[ForeignKey]
		[DataMember][XmlElement(Order = 90)]public Int32? BuildID { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 91)]public virtual string EntityTypeName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 92)]public virtual string EntityStateName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 93)]public virtual string PriorityName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 94)]public virtual string ProjectName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 95)]public virtual string IterationName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 96)]public virtual string ParentName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 97)]public virtual string ReleaseName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 98)]public virtual string TestPlanName { get; set; }

		/// <summary>
        /// Gets or sets the Build Name. Reference to Build
        /// </summary>
        /// <value>The Build Name.</value>
		[RelationName]
		[DataMember][XmlElement(Order = 99)]public virtual string BuildName { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 100)]public Int32? EntityTypeID { get; set; }

		[ForeignKey]
		[DataMember][XmlElement(Order = 101)]
		public Int32? SquadID { get; set; }

		[RelationName]
		[DataMember][XmlElement(Order = 102)]
