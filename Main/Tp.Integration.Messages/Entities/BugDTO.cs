...
{
    /// <summary>
    /// Data Transfer object of Bug. Represents bug or defect (error, flaw, mistake, failure, or fault in a computer program).
    /// </summary>
	...
	public partial class BugDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? BugID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 77)]public Int32? LastCommentUserID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 78)]public Int32? OwnerID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 79)]public Int32? LastEditorID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 80)]public Int32? EntityStateID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 81)]public Int32? PriorityID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 82)]public Int32? ProjectID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 83)]public Int32? IterationID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 84)]public Int32? ParentID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 85)]public Int32? ReleaseID { get; set; }

		/// <summary>
        /// Gets or sets the Severity ID. Severity (measure of injuriousness) of the bug. For example, Blocking, Critical, Small
        /// </summary>
        /// <value>The Severity ID.</value>
		[ForeignKey]
		[DataMember][XmlElement(Order = 86)]public Int32? SeverityID { get; set; }

		/// <summary>
        /// Gets or sets the Build ID. Build in which bug has been found. Optional.
        /// </summary>
        /// <value>The Build ID.</value>
		[ForeignKey]
		[DataMember][XmlElement(Order = 87)]public Int32? BuildID { get; set; }

		/// <summary>
        /// Gets or sets the User Story ID. Bug may be associated with user story. Optional.
        /// </summary>
        /// <value>The User Story ID.</value>
		[ForeignKey]
		[DataMember][XmlElement(Order = 88)]public Int32? UserStoryID { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 89)]public virtual string EntityTypeName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 90)]public virtual string EntityStateName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 91)]public virtual string PriorityName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 92)]public virtual string ProjectName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 93)]public virtual string IterationName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 94)]public virtual string ParentName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 95)]public virtual string ReleaseName { get; set; }

		/// <summary>
        /// Gets or sets the Severity Name. Severity (measure of injuriousness) of the bug. For example, Blocking, Critical, Small
        /// </summary>
        /// <value>The Severity Name.</value>
		[RelationName]
		[DataMember][XmlElement(Order = 96)]public virtual string SeverityName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 97)]public virtual string BuildName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 98)]public virtual string UserStoryName { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 99)]public Int32? EntityTypeID { get; set; }

		[ForeignKey]
		[DataMember][XmlElement(Order = 100)]
