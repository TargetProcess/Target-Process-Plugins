...
namespace Tp.Integration.Common
{
	...
	public partial class RequesterDTO : DataTransferObject
	{
		...
		[XmlElement(Order = 15)]public String Phone { get; set; }

		/// <summary>
        /// Gets or sets the Notes. 
        /// </summary>
        /// <value>The Notes.</value>
		[XmlElement(Order = 16)]public String Notes { get; set; }

		/// <summary>
        /// Gets or sets the Source Type. 
        /// </summary>
        /// <value>The Source Type.</value>
		[XmlElement(Order = 17)]public RequesterSourceTypeEnum? SourceType { get; set; }
		...
		[ForeignKey]
		[XmlElement(Order = 18)]public Int32? CompanyID { get; set; }
