...
{
    /// <summary>
    /// Data Transfer object of Solution. 
    /// </summary>
	[Serializable][DataContract]
	public partial class SolutionDTO : DataTransferObject
	{
        /// <summary>
        /// Gets or sets the ID.
        /// </summary>
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? SolutionID { get; set; }
		...
		[DataMember][XmlElement(Order = 72)]public String Problem { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 77)]public virtual string ParentProjectName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 78)]public virtual string EntityTypeName { get; set; }
