...
namespace Tp.Integration.Common
{
	...
	public partial class SquadIterationDTO : DataTransferObject
	{
        /// <summary>
        /// Gets or sets the ID.
        /// </summary>
		...
		{
			get { return SquadIterationID; }
			set
			{
				if (value == int.MinValue)
					value = null;

				SquadIterationID = value;
			}
		}
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? SquadIterationID { get; set; }
		...
		[DataMember][XmlElement(Order = 72)]public Decimal? Velocity { get; set; }

		/// <summary>
        /// Gets or sets the Duration. Iteration duration in weeks
        /// </summary>
        /// <value>The Duration.</value>
		[DataMember][XmlElement(Order = 73)]public Int32? Duration { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 74)]public Int32? LastCommentUserID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 75)]public Int32? ParentProjectID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 76)]public Int32? OwnerID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 77)]public Int32? LastEditorID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 82)]public Int32? EntityTypeID { get; set; }
    ...
    /// Iteration fields
    /// </summary>
	public enum SquadIterationField
	{
        /// <summary>
        /// Name
        /// </summary>		
