...
{
	// Autogenerated from RuleEngineUser.hbm.xml properties: UserID: int?
	public partial interface IRuleEngineUserDTO : IGeneralUserDTO
	{
	}

	[Serializable]
	[DataContract]
	public partial class RuleEngineUserDTO : DataTransferObject, IRuleEngineUserDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
	...
	public enum RuleEngineUserField
	{
		FirstName,
		LastName,
		Email,
