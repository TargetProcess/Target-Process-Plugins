...
{
	// Autogenerated from LookupGeneralListItem.hbm.xml properties: GeneralID: Int32?, Name: String, ParentProjectID: Int32?, ProjectName: String, ProjectAbbreviation: String, EntityTypeID: Int32?, EntityTypeAbbreviation: String, Icon: String, IsTermEntity: Boolean?, NumericPriority: Double?, CreateDate: DateTime?, StartDate: DateTime?, EndDate: DateTime?, IterationID: int?, IterationName: string, ReleaseID: int?, ReleaseName: string, EntityStateID: int?, EntityStateName: string
