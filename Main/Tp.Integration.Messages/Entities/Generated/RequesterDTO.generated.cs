...
{
	// Autogenerated from Requester.hbm.xml properties: Phone: String, Notes: String, SourceType: RequesterSourceTypeEnum?, CompanyID: int?, UserID: int?
	public partial interface IRequesterDTO : IGeneralUserDTO
	{
		String Phone { get; set; }
		String Notes { get; set; }
		RequesterSourceTypeEnum? SourceType { get; set; }
		int? CompanyID { get; set; }
	}

	[Serializable]
	[DataContract]
	public partial class RequesterDTO : DataTransferObject, IRequesterDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
