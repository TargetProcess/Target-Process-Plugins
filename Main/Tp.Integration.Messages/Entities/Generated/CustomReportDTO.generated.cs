...
{
	// Autogenerated from CustomReport.hbm.xml properties: CustomReportID: Int32?, Name: String, ReportingEntityName: String, IsPublic: Boolean?, Content: string, ProcessID: int?, ProcessName: string, OwnerID: int?
