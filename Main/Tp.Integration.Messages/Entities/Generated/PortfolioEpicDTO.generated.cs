...
{
	// Autogenerated from PortfolioEpic.hbm.xml properties: PortfolioEpicID: Int32?, InitialEstimate: Decimal?
	public partial interface IPortfolioEpicDTO : IAssignableDTO
	{
	...
	[Serializable]
	[DataContract]
	public partial class PortfolioEpicDTO : DataTransferObject, IPortfolioEpicDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
		public override int? ID
		{
			get { return PortfolioEpicID; }
			set
			{
				if (value == int.MinValue)
					value = null;

				PortfolioEpicID = value;
			}
		}
		[PrimaryKey]
		[DataMember]
		[XmlElement(Order=3)]
		public Int32? PortfolioEpicID { get; set; }
	...
	public enum PortfolioEpicField
	{
		Name,
		Description,
		StartDate,
