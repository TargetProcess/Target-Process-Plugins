...
{
	// Autogenerated from TestPlan.hbm.xml properties: InitialEstimate: Decimal?, CalculatedEstimate: Decimal?, TestPlanID: Int32?, ProjectID: int?, ProjectName: string, LinkedGeneralID: int?, LinkedGeneralName: string
	public partial interface ITestPlanDTO : IAssignableDTO
	{
		Decimal? InitialEstimate { get; set; }
		Decimal? CalculatedEstimate { get; set; }
		int? LinkedGeneralID { get; set; }
		string LinkedGeneralName { get; set; }
	}

	[Serializable]
	[DataContract]
	public partial class TestPlanDTO : DataTransferObject, ITestPlanDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
		...
		public int? LinkedGeneralID { get; set; }

		[RelationName]
		[DataMember]
		[XmlElement(Order=102)]
		public string LinkedGeneralName { get; set; }
