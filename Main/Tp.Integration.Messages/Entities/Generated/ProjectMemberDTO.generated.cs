...
{
	// Autogenerated from ProjectMember.hbm.xml properties: ProjectMemberID: Int32?, WeeklyAvailableHours: Decimal?, MembershipStartDate: DateTime?, MembershipEndDate: DateTime?, IsMembershipStartDateLinked: Boolean?, IsMembershipEndDateLinked: Boolean?, Allocation: Int32?, ProjectID: int?, ProjectName: string, UserID: int?, RoleID: int?, RoleName: string
