...
{
	// Autogenerated from TestPlanRun.hbm.xml properties: TestPlanRunID: Int32?, NotRunCount: Int32?, PassedCount: Int32?, TestPlanNumericPriority: Double?, FailedCount: Int32?, OnHoldCount: Int32?, BlockedCount: Int32?, IsLastStarted: Boolean?, TestPlanID: int?, TestPlanName: string, ProjectID: int?, ProjectName: string, IterationID: int?, IterationName: string, BuildID: int?, BuildName: string, ReleaseID: int?, ReleaseName: string, ParentTestPlanRunID: int?, ParentTestPlanRunName: string
