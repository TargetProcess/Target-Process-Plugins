...
{
	// Autogenerated from Epic.hbm.xml properties: EpicID: Int32?, InitialEstimate: Decimal?, PortfolioEpicID: int?, PortfolioEpicName: string, BuildID: int?, BuildName: string
