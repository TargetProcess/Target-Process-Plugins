...
{
	// Autogenerated from RoleEntityType.hbm.xml properties: RoleEntityTypeID: Int32?, IsDeleteEnabled: Boolean?, IsEditEnabled: Boolean?, IsAddEnabled: Boolean?, EntityTypeID: int?, EntityTypeName: string, RoleID: int?, RoleName: string
	...
	public partial class RoleEntityTypeDTO : DataTransferObject, IRoleEntityTypeDTO
	{
		...
		[DataMember]
		[XmlElement(Order=10)]
		public Boolean? IsAddEnabled { get; set; }
	}
