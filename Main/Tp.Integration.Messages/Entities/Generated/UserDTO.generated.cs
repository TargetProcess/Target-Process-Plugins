...
{
	// Autogenerated from User.hbm.xml properties: LastLoginDate: DateTime?, ActiveDirectoryName: String, WeeklyAvailableHours: Decimal?, CurrentAllocation: Int32?, CurrentAvailableHours: Decimal?, AvailableFrom: DateTime?, AvailableFutureAllocation: Int32?, AvailableFutureHours: Decimal?, IsObserver: Boolean?, IsContributor: Boolean?, RichEditor: RichEditorTypeEnum?, DefaultRoleID: int?, DefaultRoleName: string, UserID: int?, RoleID: int?, RoleName: string
	public partial interface IUserDTO : IGeneralUserDTO
	{
		DateTime? LastLoginDate { get; set; }
		String ActiveDirectoryName { get; set; }
		Decimal? WeeklyAvailableHours { get; set; }
		Int32? CurrentAllocation { get; set; }
		Decimal? CurrentAvailableHours { get; set; }
		DateTime? AvailableFrom { get; set; }
		Int32? AvailableFutureAllocation { get; set; }
		Decimal? AvailableFutureHours { get; set; }
		Boolean? IsObserver { get; set; }
		Boolean? IsContributor { get; set; }
		RichEditorTypeEnum? RichEditor { get; set; }
		int? DefaultRoleID { get; set; }
	...
	[Serializable]
	[DataContract]
	public partial class UserDTO : DataTransferObject, IUserDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
