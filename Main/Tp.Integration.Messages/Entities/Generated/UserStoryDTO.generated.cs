...
{
	// Autogenerated from UserStory.hbm.xml properties: UserStoryID: Int32?, InitialEstimate: Decimal?, IterationID: int?, IterationName: string, FeatureID: int?, FeatureName: string
