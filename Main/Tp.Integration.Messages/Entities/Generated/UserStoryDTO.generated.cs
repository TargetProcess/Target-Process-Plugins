...
{
	// Autogenerated from UserStory.hbm.xml properties: UserStoryID: Int32?, InitialEstimate: Decimal?, IterationID: int?, IterationName: string, FeatureID: int?, FeatureName: string, BuildID: int?, BuildName: string
	public partial interface IUserStoryDTO : IAssignableDTO
	{
	...
	[Serializable]
	[DataContract]
	public partial class UserStoryDTO : DataTransferObject, IUserStoryDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
