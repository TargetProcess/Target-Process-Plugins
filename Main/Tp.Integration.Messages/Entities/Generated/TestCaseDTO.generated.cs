...
{
	// Autogenerated from TestCase.hbm.xml properties: TestCaseID: Int32?, Steps: string, Success: string, LastStatus: Boolean?, LastRunStatus: TestCaseRunStatusDTO, LastFailureComment: string, LastRunDate: DateTime?, UserStoryID: int?, UserStoryName: string, ProjectID: int?, ProjectName: string, PriorityID: int?, PriorityName: string
	public partial interface ITestCaseDTO : IGeneralDTO
	{
		string Steps { get; set; }
		string Success { get; set; }
		Boolean? LastStatus { get; set; }
	...
	[Serializable]
	[DataContract]
	public partial class TestCaseDTO : DataTransferObject, ITestCaseDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
