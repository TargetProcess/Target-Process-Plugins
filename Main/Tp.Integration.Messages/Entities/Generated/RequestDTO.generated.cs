...
{
	// Autogenerated from Request.hbm.xml properties: RequestID: Int32?, SourceType: RequestSourceEnum?, IsPrivate: Boolean?, VotesCount: Int32?, IsReplied: Boolean?, RequestTypeID: int?, RequestTypeName: string
