...
{
	// Autogenerated from Request.hbm.xml properties: RequestID: Int32?, SourceType: RequestSourceEnum?, IsPrivate: Boolean?, VotesCount: Int32?, IsReplied: Boolean?, RequestTypeID: int?, RequestTypeName: string, BuildID: int?, BuildName: string
	public partial interface IRequestDTO : IAssignableDTO
	{
		RequestSourceEnum? SourceType { get; set; }
		Boolean? IsPrivate { get; set; }
		Int32? VotesCount { get; set; }
		Boolean? IsReplied { get; set; }
	...
	[Serializable]
	[DataContract]
	public partial class RequestDTO : DataTransferObject, IRequestDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
