...
{
	// Autogenerated from SquadIteration.hbm.xml properties: SquadIterationID: Int32?, Capacity: Decimal?, Velocity: Decimal?, Duration: Int32?, Progress: Decimal?, Effort: Decimal?, EffortCompleted: Decimal?, EffortToDo: Decimal?, SquadID: int?, SquadName: string, ReleaseID: int?, ReleaseName: string
	public partial interface ISquadIterationDTO : IGeneralDTO
	{
	...
	[Serializable]
	[DataContract]
	public partial class SquadIterationDTO : DataTransferObject, ISquadIterationDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
		...
		[DataMember]
		[XmlElement(Order=3)]
		public Int32? SquadIterationID { get; set; }
