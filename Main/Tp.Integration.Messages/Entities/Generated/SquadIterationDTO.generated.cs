...
{
	// Autogenerated from SquadIteration.hbm.xml properties: SquadIterationID: Int32?, Velocity: Decimal?, Duration: Int32?, Progress: Decimal?, Effort: Decimal?, EffortCompleted: Decimal?, EffortToDo: Decimal?, SquadID: int?, SquadName: string
