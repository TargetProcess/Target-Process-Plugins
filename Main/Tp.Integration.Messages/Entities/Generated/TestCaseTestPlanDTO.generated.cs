...
{
	// Autogenerated from TestCaseTestPlan.hbm.xml properties: TestCaseTestPlanID: Int32?, NumericPriority: Double?, TestPlanID: int?, TestPlanName: string, TestCaseID: int?, TestCaseName: string
