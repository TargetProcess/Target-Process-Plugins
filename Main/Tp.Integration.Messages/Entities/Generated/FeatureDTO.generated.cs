...
{
	// Autogenerated from Feature.hbm.xml properties: FeatureID: Int32?, InitialEstimate: Decimal?, EpicID: int?, EpicName: string, PortfolioEpicID: int?, PortfolioEpicName: string, BuildID: int?, BuildName: string
	public partial interface IFeatureDTO : IAssignableDTO
	{
		Decimal? InitialEstimate { get; set; }
		int? EpicID { get; set; }
		string EpicName { get; set; }
		int? PortfolioEpicID { get; set; }
		string PortfolioEpicName { get; set; }
		int? BuildID { get; set; }
