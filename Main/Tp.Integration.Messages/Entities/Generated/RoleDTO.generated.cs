...
{
	// Autogenerated from Role.hbm.xml properties: RoleID: Int32?, Name: String, Description: String, TimeSheetAccess: Boolean?, PeopleAccess: Boolean?, CanChangeOwner: Boolean?, CanPrioritize: Boolean?, HaveEffort: Boolean?
	...
	public partial class RoleDTO : DataTransferObject, IRoleDTO
	{
		...
		[DataMember]
		[XmlElement(Order=12)]
		public Boolean? CanPrioritize { get; set; }
	}
