...
{
	// Autogenerated from Bug.hbm.xml properties: BugID: Int32?, SeverityID: int?, SeverityName: string, BuildID: int?, BuildName: string, UserStoryID: int?, UserStoryName: string, FeatureID: int?, FeatureName: string
	public partial interface IBugDTO : IAssignableDTO
	{
	...
	[Serializable]
	[DataContract]
	public partial class BugDTO : DataTransferObject, IBugDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
