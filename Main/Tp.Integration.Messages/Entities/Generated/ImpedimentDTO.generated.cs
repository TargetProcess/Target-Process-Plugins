...
{
	// Autogenerated from Impediment.hbm.xml properties: ImpedimentID: Int32?, PlannedStartDate: DateTime?, PlannedEndDate: DateTime?, IsPrivate: Boolean?, AssignableID: int?, AssignableName: string, EntityStateID: int?, EntityStateName: string, PriorityID: int?, PriorityName: string, ProjectID: int?, ProjectName: string, ResponsibleID: int?, ResponsibleName: string
	public partial interface IImpedimentDTO : IGeneralDTO
	{
	...
	[Serializable]
	[DataContract]
	public partial class ImpedimentDTO : DataTransferObject, IImpedimentDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
		...
		[DataMember]
		[XmlElement(Order=3)]
		public Int32? ImpedimentID { get; set; }
