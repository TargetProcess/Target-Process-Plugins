...
{
	// Autogenerated from SystemUser.hbm.xml properties: UserID: int?
	public partial interface ISystemUserDTO : IGeneralUserDTO
	{
	}

	[Serializable]
	[DataContract]
	public partial class SystemUserDTO : DataTransferObject, ISystemUserDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
