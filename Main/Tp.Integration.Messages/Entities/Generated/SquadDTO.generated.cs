...
{
	// Autogenerated from Squad.hbm.xml properties: TeamID: Int32?, Icon: String, EmojiIcon: String, IsActive: Boolean?, Abbreviation: String
	public partial interface ISquadDTO : IGeneralDTO
	{
		String Icon { get; set; }
		String EmojiIcon { get; set; }
	...
	[Serializable]
	[DataContract]
	public partial class SquadDTO : DataTransferObject, ISquadDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
