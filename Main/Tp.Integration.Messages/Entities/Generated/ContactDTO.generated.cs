...
{
	// Autogenerated from Contact.hbm.xml properties: OwnerID: int?, UserID: int?, ContactOwnerID: int?
	public partial interface IContactDTO : IGeneralUserDTO
	{
		int? OwnerID { get; set; }
		int? ContactOwnerID { get; set; }
	}

	[Serializable]
	[DataContract]
	public partial class ContactDTO : DataTransferObject, IContactDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
