...
{
	// Autogenerated from Build.hbm.xml properties: BuildID: Int32?, BuildDate: DateTime?, IterationID: int?, IterationName: string, ReleaseID: int?, ReleaseName: string, ProjectID: int?, ProjectName: string
	public partial interface IBuildDTO : IGeneralDTO
	{
	...
	[Serializable]
	[DataContract]
	public partial class BuildDTO : DataTransferObject, IBuildDTO, ICustomFieldHolderDTO
	{
		[PrimaryKey]
