...
namespace Tp.Integration.Common
{
	...
	public partial class RequestDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? RequestID { get; set; }
		...
		[DataMember][XmlElement(Order = 77)]public RequestSourceEnum? SourceType { get; set; }

		/// <summary>
        /// Gets or sets the Is Private. visibility of request
        /// </summary>
        /// <value>The Is Private.</value>
		[DataMember][XmlElement(Order = 78)]public Boolean? IsPrivate { get; set; }

		/// <summary>
        /// Gets or sets the Is Replied. Is Replied
        /// </summary>
        /// <value>The Is Replied.</value>
		[DataMember][XmlElement(Order = 79)]public Boolean? IsReplied { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 89)]public Int32? RequestTypeID { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 90)]public virtual string EntityTypeName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 91)]public virtual string EntityStateName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 92)]public virtual string PriorityName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 93)]public virtual string ProjectName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 94)]public virtual string IterationName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 95)]public virtual string ParentName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 96)]public virtual string ReleaseName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 97)]public virtual string RequestTypeName { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 98)]public Int32? EntityTypeID { get; set; }

		[ForeignKey]
		[DataMember][XmlElement(Order = 99)]
