...
namespace Tp.Integration.Common
{
	...
	public partial class BuildDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? BuildID { get; set; }
		...
		[DataMember][XmlElement(Order = 72)]public DateTime? BuildDate { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 74)]public Int32? ParentProjectID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 75)]public Int32? OwnerID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 76)]public Int32? LastEditorID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 77)]public Int32? IterationID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 78)]public Int32? ReleaseID { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 79)]public virtual string ParentProjectName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 80)]public virtual string EntityTypeName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 81)]public virtual string IterationName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 82)]public virtual string ReleaseName { get; set; }
