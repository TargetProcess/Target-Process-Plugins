...
namespace Tp.Integration.Common
{
	...
	public partial class BuildDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[XmlElement(Order = 3)]public int? BuildID { get; set; }
		...
		[XmlElement(Order = 27)]public DateTime? BuildDate { get; set; }
		...
		[ForeignKey]
		[XmlElement(Order = 32)]public Int32? IterationID { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 36)]public virtual string IterationName { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 37)]public virtual string ReleaseName { get; set; }
