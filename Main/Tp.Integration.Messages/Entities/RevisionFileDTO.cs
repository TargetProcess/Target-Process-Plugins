...
namespace Tp.Integration.Common
{
	...
	public partial class RevisionFileDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[XmlElement(Order = 3)]public int? RevisionFileID { get; set; }
		...
		[ForeignKey]
		[XmlElement(Order = 6)]public Int32? RevisionID { get; set; }
