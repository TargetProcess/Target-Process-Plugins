...
namespace Tp.Integration.Common
{
	...
	public partial class ProgramDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? ProgramID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 73)]public Int32? ParentProjectID { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 76)]public virtual string ParentProjectName { get; set; }
