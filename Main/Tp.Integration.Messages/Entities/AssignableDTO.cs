...
{
    /// <summary>
    /// Data Transfer object of Assignable. Base class for all assignable classes (User Story, Task, Bug, Test Plan Run). Assignable entity can be assigned to User.
    /// </summary>
	[Serializable][DataContract]
	public partial class AssignableDTO : DataTransferObject
	{
        /// <summary>
        /// Gets or sets the ID.
        /// </summary>
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? AssignableID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 80)]public Int32? EntityTypeID { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 94)]
		public virtual Int32? SquadID { get; set; }

		[RelationName]
		[DataMember][XmlElement(Order = 95)]
		public virtual string SquadName { get; set; }
