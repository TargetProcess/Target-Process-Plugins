...
namespace Tp.Integration.Common
{
	...
	public partial class TestCaseDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? TestCaseID { get; set; }
		...
		[DataMember][XmlElement(Order = 72)]public String Steps { get; set; }

		/// <summary>
        /// Gets or sets the Success. Expected results
        /// </summary>
        /// <value>The Success.</value>
		[DataMember][XmlElement(Order = 73)]public String Success { get; set; }
		...
		[DataMember][XmlElement(Order = 75)]public String LastFailureComment { get; set; }

		/// <summary>
        /// Gets or sets the Last Run Date. Date when test case was run last time
        /// </summary>
        /// <value>The Last Run Date.</value>
		[DataMember][XmlElement(Order = 76)]public DateTime? LastRunDate { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 80)]public Int32? UserStoryID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 81)]public Int32? ProjectID { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 83)]public virtual string EntityTypeName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 84)]public virtual string UserStoryName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 86)]public virtual string PriorityName { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 87)]public Int32? EntityTypeID { get; set; }
