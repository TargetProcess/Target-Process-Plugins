...
namespace Tp.Integration.Common
{
	...
	public partial class ImpedimentDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? ImpedimentID { get; set; }
		...
		[DataMember][XmlElement(Order = 72)]public Boolean? IsPrivate { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 73)]public Int32? LastCommentUserID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 74)]public Int32? OwnerID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 75)]public Int32? LastEditorID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 76)]public Int32? AssignableID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 77)]public Int32? EntityStateID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 78)]public Int32? PriorityID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 79)]public Int32? ProjectID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 80)]public Int32? ResponsibleID { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 81)]public virtual string EntityTypeName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 82)]public virtual string AssignableName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 83)]public virtual string EntityStateName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 84)]public virtual string PriorityName { get; set; }
