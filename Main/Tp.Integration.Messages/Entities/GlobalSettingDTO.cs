...
namespace Tp.Integration.Common
{
	...
	public partial class GlobalSettingDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[XmlElement(Order = 3)]public int? GlobalSettingID { get; set; }
		...
		[XmlElement(Order = 15)]public Boolean? NotifyRequester { get; set; }
