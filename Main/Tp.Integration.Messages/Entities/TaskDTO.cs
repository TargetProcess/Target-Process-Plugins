...
namespace Tp.Integration.Common
{
	...
	public partial class TaskDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[DataMember][XmlElement(Order = 3)]public int? TaskID { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 86)]public Int32? UserStoryID { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 91)]public virtual string IterationName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 93)]public virtual string ReleaseName { get; set; }
		...
		[RelationName]
		[DataMember][XmlElement(Order = 94)]public virtual string UserStoryName { get; set; }
		...
		[ForeignKey]
		[DataMember][XmlElement(Order = 95)]public Int32? EntityTypeID { get; set; }
