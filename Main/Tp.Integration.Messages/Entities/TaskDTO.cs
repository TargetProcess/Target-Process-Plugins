...
namespace Tp.Integration.Common
{
	...
	public partial class TaskDTO : DataTransferObject
	{
		...
		[PrimaryKey]
		[XmlElement(Order = 3)]public int? TaskID { get; set; }
		...
		[ForeignKey]
		[XmlElement(Order = 41)]public Int32? UserStoryID { get; set; }
		...
		[RelationName]
		[XmlElement(Order = 49)]public virtual string UserStoryName { get; set; }
		...
		[ForeignKey]
		[XmlElement(Order = 50)]public Int32? EntityTypeID { get; set; }
	}
