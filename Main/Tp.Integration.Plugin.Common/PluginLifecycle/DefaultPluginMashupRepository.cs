	...
	public class DefaultPluginMashupRepository : IPluginMashupRepository
	{
		...
		public PluginMashup[] PluginMashups
		{
			get
			{
				...
				var result = mashupCollection.Select(mashup => mashup.MashupName == ProfileEditorMashupName.ProfileEditorMashupPrefix ? new PluginProfileEditorMashup(mashup.MashupFilePaths) : new PluginMashup(mashup.MashupName, mashup.MashupFilePaths, new string[] { })).ToList();
