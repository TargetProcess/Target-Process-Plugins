...
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field, {
	...
	msHeight: 300,
	hideNavIcons: false,
	imagePath: appHostAndPath + "\\App_Themes\\Main\\Ext\\resources\\images\\tp\\multiSelect\\",
	iconUp: "up2.gif",
	iconDown: "down2.gif",
	iconLeft: "left2.gif",
	...
	onRender: function (ct, position) {
		...
		p.add({ text: this.fromHeader, xtype: 'label', cls: this.fromHeaderCls });
		p.add({ xtype: 'label' });
		p.add({ text: this.toHeader, xtype: 'label', cls: this.toHeaderCls });
