...
#pragma warning disable 1712
    ...
    public static MethodInfo GetMethod<T1, T2, T3, T4, T5, T6, T7, TResult>(
        Expression<Func<Func<T1, T2, T3, T4, T5, T6, T7, TResult>>> method)
    {
        return GetDelegateMethodInfo(method);
    }
    ...
    public static MethodInfo GetMethod<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
        Expression<Func<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>>> method)
    {
        return GetDelegateMethodInfo(method);
    }
...
public static partial class Reflect<TTarget>
{
    ...
    /// <exception cref="ArgumentException">The <paramref name="method"/> is not a lambda expression or it does not represent a method invocation.</exception>
    /// <returns>The method info.</returns>
    public static MethodInfo GetMethod<T1, T2, T3, T4, T5, T6, TResult>(
        Expression<Func<TTarget, Func<T1, T2, T3, T4, T5, T6, TResult>>> method)
    {
        return GetDelegateMethodInfo(method);
    }
    ...
    /// <exception cref="ArgumentException">The <paramref name="method"/> is not a lambda expression or it does not represent a method invocation.</exception>
    /// <returns>The method info.</returns>
    public static MethodInfo GetMethod<T1, T2, T3, T4, T5, T6, T7, T8>(
        Expression<Func<TTarget, Action<T1, T2, T3, T4, T5, T6, T7, T8>>> method)
    {
        return GetDelegateMethodInfo(method);
    }
