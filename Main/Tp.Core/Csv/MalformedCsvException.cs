...
namespace Tp.Utils.Csv
{
    ...
    public class MalformedCsvException : ApplicationException
    {
        ...
        /// <summary>
        /// Contains the column index of the position at which the error occurred.
        /// </summary>
        ...
        /// <param name="column">The column index of the position at which the error occurred.</param>
        ...
        /// <summary>
        /// Gets the column index of the position at which the error occurred.
        /// </summary>
        /// <value>The column index of the position at which the error occurred.</value>
        public int Column
        {
            get { return _column; }
        }
