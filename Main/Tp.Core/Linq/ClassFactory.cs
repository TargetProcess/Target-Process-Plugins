...
// ReSharper restore CheckNamespace
{
	public class ClassFactory
	{
		...
		private static MethodBuilder GenerateIndexerGetter(TypeBuilder typeBuilder, IEnumerable<FieldInfo> fields, string reservedIndexerName)
		{
			var indexerGetter = typeBuilder.DefineMethod("get_" + reservedIndexerName,
				MethodAttributes.Public | MethodAttributes.HideBySig | MethodAttributes.SpecialName, typeof(object), new[] { typeof(string) });
