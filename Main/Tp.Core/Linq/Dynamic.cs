...
//			}
		...
		private Expression ParseNew(bool curly=false)
		{
			if (!curly)
			{
				NextToken();
			...
			ValidateToken(curly?TokenId.CloseCurly : TokenId.CloseParen, Res.CloseParenOrCommaExpected);
			NextToken();
